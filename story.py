...
tutorialAnswer = [
    f"You check around and notice some liquid on the grass, you smell it and sure enough its petrol seems a little odd".center(160) + "\n" +
...
def tutorialMenu():
    while len(tutorialClues) != 0: 
        typeWriter(f"Investigation Menu".center(160) + "\n\n\n")
